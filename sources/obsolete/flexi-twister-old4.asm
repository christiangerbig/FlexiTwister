...
swap_playfield1_loop
  ...
  CNOP 0,4
hst_swap_y_offset
  move.w  hst_y_offset(a3),d0
  move.w  hst_y_offset+2(a3),hst_y_offset(a3)
  move.w  d0,hst_y_offset+2(a3)
  rts
