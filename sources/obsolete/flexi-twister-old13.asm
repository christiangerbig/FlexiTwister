...
hst_restart_text
  ...
  DC.B "YES!  THIS IS PURE RASTERMANIA!  CHECKOUT THE SPRITES!  THE LOGO IS A CLUSTER OF EIGHT ATTACHED SPRITES DISPLAYED ON AN OVERSCAN SCREEN WITHOUT RESTRICSTIONS!           "
