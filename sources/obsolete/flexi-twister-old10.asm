...
; PT 8xy-Befehl
; 800 Start Intro
; 810 Start Scrolltext
; 820 Start Vert-Scroll-Logo-In
; 830 Start Columns-Fader-In
...
; **** Vert-Scroll-Logo ****
vsl_y_radius                   EQU 256
vsl_y_center                   EQU 256

vsli_y_angle_speed             EQU 1

vslo_y_angle_speed             EQU 2
...
ccfi_columns_delay1            EQU 1
ccfi_columns_delay2            EQU 1
...
; **** Chunky-Columns-Fader ****
  lea     tb_fader_columns_mask(pc),a0
...
ssb_init_color_table
  lea     ssb_colorgradient_light(pc),a0
  lea     ssb_colorgradient_dark(pc),a1
  move.l  extra_memory(a3),a2
  ADDF.L  em_color_table,a2
...
ccfo_mode2_column_fader_out
  ...
  neg.w   d0                 ;Vorzeichen umdrehen
  addq.w  #1,d1              ;nächste Spalte
  not.b   (cl2_display_width-1)-1(a0,d0.w) ;Spaltenstatus = FALSE (ausblenden)
...
; **** Sine-Stripes-Bar ****
ssb_colorgradient_light
  INCLUDE "Daten:Asm-Sources.AGA/FlexiTwister/colortables/Striped-Bar-Colorgradient-1.ct"

ssb_colorgradient_dark
  INCLUDE "Daten:Asm-Sources.AGA/FlexiTwister/colortables/Striped-Bar-Colorgradient-2.ct"
...
lg_image_data SECTION lg_gfx,DATA
  INCBIN "Daten:Asm-Sources.AGA/FlexiTwister/graphics/256x54x8x2-Dissident-2.rawblit"
