...
tb_y_radius                    EQU (cl2_display_y_size-tb_bar_height)/2
tb_y_center                    EQU (cl2_display_y_size-tb_bar_height)/2
tb_y_angle_speed               EQU 3 ;4
tb_y_angle_step                EQU 3
...
hst_horiz_scroll_window_x_size EQU visible_pixels_number+(hst_text_character_x_size*2)
...
init_second_copperlist
  ...
  COP_INIT_BPLCON4_CHUNKY_SCREEN cl2,cl2_HSTART1,cl2_VSTART1,cl2_display_x_size,cl2_display_y_size,FALSE,tb_quick_clear,FALSE
...
; ------------------------
  CNOP 0,4
swap_playfield1
  move.l  pf1_construction2(a3),a1 ;Playfields vertauschen
...
; -------------------------------
  GET_TWISTED_BARS_YZ_COORDINATES tb,sine_table_length,cl2_extension1_SIZE
...
; ---------------------------------------------
  SET_TWISTED_BACKGROUND_BARS.B tb,cl2,construction2,extension1,bar_height,extra_memory,a3
...
; ---------------------------------------------
  SET_TWISTED_FOREGROUND_BARS.B tb,cl2,construction2,extension1,bar_height,extra_memory,a3
...
horiz_scrolltext
  ...
  move.l  pf1_construction2(a3),a2 ;Playfield
  move.l  (a2),d3
...
hst_text
  REPT hst_text_characters_number/(hst_origin_character_x_size/hst_text_character_x_size)
    DC.B " "
  ENDR
  DC.B "DISSIDENT IS PROUD TO PRESET A NEW INTRO CALLED  -FLEXI TWISTER-  "
  DC.B FALSE
  EVEN
